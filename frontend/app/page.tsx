...
export default function Home() {
  return (
    <div className="container mx-auto w-full flex justify-between py-6 mt-28 flex-grow">
      <Link
        href="/song"
        className="p-4 w-full border-r border-border guitar-bg flex-grow cursor-pointer"
      >
      ...
      <Link
        href="/album"
        className="p-4 w-full border-l border-border album-bg flex-grow cursor-pointer"
      >
